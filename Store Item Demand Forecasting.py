...
train=pd.read_csv("datasets/train_d.csv",parse_dates=["date"])
test=pd.read_csv("datasets/test_d.csv",parse_dates=["date"])
...
def roll_mean_features(dataframe,windows):
    for window in windows:
        dataframe["sales_role_mean_" + str(window)]=dataframe.groupby(["store","item"])["sales"].\
...
lgbtrain_all=lgb.Dataset(X_train,label=Y_train,feature_name=cols)
